...
const SalesList = () => {
  ...
  const handleQuantityRateChange = (index: number) => {
    ...
    if (
      ...
      quantity > medicationData[medicationName].available_quantity
    ) {
      message.error(
        `Only ${medicationData[medicationName].available_quantity} units available for ${medicationName}`
      );
      return;
    }
  ...
  const handleMedicineChange = (value: string, index: number) => {
    ...
    if (medicationData[value]) {
      medications[index].expire_date = moment(
        medicationData[value].expire_date
      );
    ...
    <>
      ...
      >
        ...
        <div className="bg-white p-5  shadow-lg mt-5">
          ...
          <Row gutter={16}>
            <Col span={24}>
              <Form.Item name="customer_search" label="Search Customer">
                <AutoComplete
                      ...
                      <Col span={5}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: "Please select the Medicine Name!",
                            },
                          ]}
                        >
                          <Select
          ...
          <Row gutter={16} className="justify-end">
            <Col span={6}>
              <Form.Item
                ...
                label="Sub Total"
                rules={[
                  { required: true, message: "Please input the Sub total!" },
                ]}
              >
